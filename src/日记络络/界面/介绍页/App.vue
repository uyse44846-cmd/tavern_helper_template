  ...
  <div class="fluid-container">
    ...
    <div class="content-container cover-image-container">
      ...
      <div class="cover-image-wrapper">
        <img
          src="https://testingcf.jsdelivr.net/gh/uyse44846-cmd/tavern_helper_template/src/日记络络/图片/卡面.png"
          alt="络络在天台上拿着粉色日记本"
          class="cover-image"
        />
        <div class="image-caption">天台上的约定，蓝色天空下的粉色心事</div>
        <a
          href="https://testingcf.jsdelivr.net/gh/uyse44846-cmd/tavern_helper_template/src/日记络络/图片/卡面.png"
          target="_blank"
